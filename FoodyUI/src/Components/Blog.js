...
import { getAllBlogs, getRecentBlogs } from "../Service/BlogService";
...
const Blog = () => {
  ...
  const fetchRecentBlog = async () => {
    try {
      ...
      console.log("Error fetching recent blog:", error);
    }
  };
  ...
  return (
    <div className="blog-container">
      ...
      <div className="blog-recent">
        <h1>
          Recent <span className="blog-highlight-style ">Posts</span>
        </h1>
        <div className="blog-stack">
          <div className="blog-back"></div>
          <button className="blog-front">
            Read Recent Articles <GrArticle />
          </button>
        </div>

        <div className="blog-recent-card">
          {recentBlog && <RecentBlogCard blog={recentBlog} />}
        </div>
      </div>
      ...
      <div className="our-blog">
        <div className="blog-title">
          <h1>
            Our <span className="blog-highlight-style ">Blogs</span>
          </h1>
          <div className="blog-stack">
            <div className="blog-back"></div>
